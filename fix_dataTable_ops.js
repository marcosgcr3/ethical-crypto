...
// 1. Add Read Data Table Node (GET)
...
// 2. Add Insert Data Table Node (INSERT)
...
// Wiring correct connection for If node
...
workflow.connections['Hay Novedades?'] = { 
    main: [
        ...
        [{ node: "Fetch Contenido", type: "main", index: 0 }] // Output 1: False branch
    ] 
};
...
fs.writeFileSync('workflow_v3_fixed_ops.json', JSON.stringify(cleanedWorkflow));
console.log('Workflow fixed with correct row operations and wiring.');
