  ...
  return (
    <article className="container mx-auto px-6 py-24 max-w-4xl bg-void text-ghost">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-dim leading-relaxed">
        ...
        <h2 className="font-heading text-2xl font-bold mt-8 mb-4 text-black uppercase tracking-tight">What is an Affiliate Link?</h2>
        ...
        <h2 className="font-heading text-2xl font-bold mt-8 mb-4 text-black uppercase tracking-tight">Amazon Associates Disclosure</h2>
        <p>Ethical Crypto is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com.</p>
        <p>As an Amazon Associate, we earn from qualifying purchases.</p>

        <h2 className="font-heading text-2xl font-bold mt-8 mb-4 text-black uppercase tracking-tight">Recommendation Standards</h2>
        ...
        <h2 className="font-heading text-2xl font-bold mt-8 mb-4 text-black uppercase tracking-tight">Copyright and Rights Reserved</h2>
        ...
        <h2 className="font-heading text-2xl font-bold mt-8 mb-4 text-black uppercase tracking-tight">Contact</h2>
