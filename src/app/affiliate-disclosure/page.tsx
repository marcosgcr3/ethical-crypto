...
export const metadata: Metadata = {
  title: 'Affiliate Disclosure — Master Transparency In Crypto Research | Ethical Crypto',
  description: 'Optimize your strategy for transparency in crypto research. Understand how Ethical Crypto maintains research independence while utilizing affiliate partnerships to fund ongoing protocol analysis.',
};
  ...
  return (
    <article className="container mx-auto px-6 py-24 max-w-4xl bg-white text-black font-sans">
      ...
      <div className="prose prose-zinc max-w-none space-y-6 text-zinc-500 leading-relaxed font-medium">
        ...
        <p>Many of the links on ethical-crypto.com are affiliate links. This means that a special tracking code is used and that we may make a small commission on the sale of an item if you purchase through one of these links. The price of the item is the same for you whether it is an affiliate link or not, and using affiliate links helps us to maintain this website and support our ongoing crypto research funding and protocol research. You can learn more about this in our ethical crypto affiliate disclosure.</p>

        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Recommendation Standards</h2>
        <p>We only recommend products or services (such as hardware wallets, security tools, or nodes) that we have thoroughly researched and believe will provide value to our readers. Our priority is always to provide high-quality protocol intelligence and transparency in crypto research to help you in your digital journey.</p>
