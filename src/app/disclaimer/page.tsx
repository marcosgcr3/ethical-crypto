  ...
  return (
    <article className="container mx-auto px-6 py-24 max-w-4xl bg-white text-black font-sans">
      ...
      <div className="prose prose-zinc max-w-none space-y-6 text-zinc-500 leading-relaxed font-medium">
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Protocol & Technology Risk</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">External Links Disclaimer</h2>
