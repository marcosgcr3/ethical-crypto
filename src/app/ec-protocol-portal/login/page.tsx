  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center -mt-20 px-6">
      <div className="max-w-md w-full bg-white p-10 rounded-3xl shadow-[0_4px_40px_rgba(0,0,0,0.06)] border border-gray-100 text-center">
        <Link href="/" className="inline-block text-bioblue font-bold uppercase tracking-[0.2em] mb-8 text-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="text-left">
            ...
            <input 
              ...
              required
              placeholder="••••••••••••••"
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-bioblue/50 text-slate text-center tracking-widest bg-gray-50" 
            />
          </div>
          ...
          <button 
            type="submit" 
            disabled={isPending}
            className="w-full bg-bioblue text-white px-6 py-4 rounded-xl font-bold hover:bg-opacity-90 transition-all uppercase tracking-widest text-sm shadow-md disabled:opacity-50"
          >
