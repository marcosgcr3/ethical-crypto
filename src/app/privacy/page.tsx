  ...
  return (
    <article className="container mx-auto px-6 py-24 max-w-4xl bg-white text-black font-sans">
      ...
      <div className="prose prose-zinc max-w-none space-y-6 text-zinc-500 leading-relaxed font-medium">
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Log Files</h2>
        <p>Ethical Crypto follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable.</p>

        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Cookies and Web Beacons</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Children's Information</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Consent</h2>
