  ...
  return (
    <article className="container mx-auto px-6 py-24 max-w-4xl bg-white text-black font-sans">
      ...
      <div className="prose prose-zinc max-w-none space-y-6 text-zinc-500 leading-relaxed font-medium">
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">License</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Financial & Technology Disclaimer</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Affiliate Disclosure</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Hyperlinking to our Content</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Limitation of Liability</h2>
        ...
        <h2 className="font-heading text-2xl font-black mt-8 mb-4 text-black uppercase tracking-tight">Governing Law</h2>
